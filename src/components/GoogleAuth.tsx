...
export function BreakMode() {
  ...
  const miniGames: MiniGame[] = [
    {
      id: '1',
      title: 'Chess',
      description: 'Play a quick chess puzzle or match',
      duration: '5-10 min',
      category: 'puzzle'
    },
    {
      id: '2',
      title: 'Sudoku',
      description: 'Solve number puzzles to sharpen your mind',
      duration: '3-8 min',
      category: 'puzzle'
    },
    {
      id: '3',
      title: 'Draw & Guess',
      description: 'Drawing game with AI guessing your sketches',
      duration: '2-5 min',
      category: 'reflex'
    },
    {
  ...
  const getGameCategoryColor = (category: string) => {
    switch (category) {
      case 'memory': return 'default';
      case 'puzzle': return 'secondary';
      case 'reflex': return 'outline';
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button size="sm" variant="outline" onClick={() => playGame(game.title)}>
                      Play
                    </Button>
                  </div>
                </GlassCard>
