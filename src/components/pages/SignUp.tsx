...
export function SignUp({ onSignUp, onGoogleSignUp, onSwitchToLogin }: SignUpProps) {
          ...
          >
            ...
            >
              <Button
                ...
                className="w-full gradient-primary text-white border-0 glow-primary hover:glow-primary disabled:opacity-50"
              >
                {isLoading ? (
                  <motion.div
                    animate={{ rotate: 360 }}
